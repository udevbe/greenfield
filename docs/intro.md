...
It can run native Wayland applications remotely and display them directly in your browser or download applications compiled to WebAssembly and run them sandboxed in your browser (experimental).
