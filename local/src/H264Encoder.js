...
module.exports = class H264Encoder {
  static create (width, height) {
    const pipeline = new gstreamer.Pipeline('appsrc name=source is-live=true ! ' +
    ...
    appsrc.setCapsFromString('video/x-raw,format=xRGB,width=' + width + ',height=' + height + ',bpp=32,depth=32,framerate=0/1')
    pipeline.play()
