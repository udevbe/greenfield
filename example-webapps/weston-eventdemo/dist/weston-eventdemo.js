...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'clients/weston-eventdemo.data';
      var REMOTE_PACKAGE_BASE = 'weston-eventdemo.data';
...
Module['FS_createPath']("/usr/share/fonts/opentype", "inter", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_clients/weston-eventdemo.data');

      };
      Module['addRunDependency']('datafile_clients/weston-eventdemo.data');
...
var wasmBinaryFile;
  wasmBinaryFile = 'weston-eventdemo.wasm';
...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        var pthreadMainJs = locateFile('weston-eventdemo.worker.js');
  ...
  instrumentWasmImports(imports) {
        var importPatterns = [/^__syscall_poll$/,/^invoke_.*$/,/^fd_sync$/,/^__wasi_fd_sync$/,/^__asyncjs__.*$/,/^emscripten_promise_await$/,/^emscripten_idb_load$/,/^emscripten_idb_store$/,/^emscripten_idb_delete$/,/^emscripten_idb_exists$/,/^emscripten_idb_load_blob$/,/^emscripten_idb_store_blob$/,/^emscripten_sleep$/,/^emscripten_wget_data$/,/^emscripten_scan_registers$/,/^emscripten_lazy_load_code$/,/^_load_secondary_module$/,/^emscripten_fiber_swap$/,/^SDL_Delay$/];
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(6, 1, fd,mode,offset_low, offset_high,len_low, len_high);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(19, 1, fd, message, flags, d1, d2, d3);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 1, fd, message, flags, d1, d2, d3);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(25, 1, target, linkpath);
...
var ___start_em_js = Module['___start_em_js'] = 1040192;
var ___stop_em_js = Module['___stop_em_js'] = 1053250;
